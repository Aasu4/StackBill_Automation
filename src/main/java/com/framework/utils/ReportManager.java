...
public abstract class ReportManager extends DriverManager{
	...
	public synchronized void startReport() {
		...
		htmlReporter.config().setDocumentTitle("StackBill-Project");
		htmlReporter.config().setEncoding("utf-8");
		htmlReporter.config().setReportName("StackBill-Project");
